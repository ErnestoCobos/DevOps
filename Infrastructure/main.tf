...
# TODO: move to a variable the static records (the ones that don't change)
# TODO: in local add the dynamic recors (the ones that are generated by terraform code)
